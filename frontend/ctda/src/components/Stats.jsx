...
import { Calendar, CalendarDays, CalendarRange, Link, Image, MessageSquare, Text } from "lucide-react";
    ...
    return (
        <div className="bg-gray-100 p-6">
            <div className="max-w-5xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-800 text-center mb-6">Statistics Overview</h1>

                {/* Top Stats Section */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                    <StatCard icon={<Text size={30} className="text-indigo-600" />} value={stats?.num_words || "0"} label="Words" />
                    <StatCard icon={<MessageSquare size={30} className="text-indigo-600" />} value={stats?.num_messages || "0"} label="Messages" />
                    <StatCard icon={<Link size={30} className="text-indigo-600" />} value={stats?.num_links || "0"} label="Links" />
                    <StatCard icon={<Image size={30} className="text-indigo-600" />} value={stats?.num_media_messages || "0"} label="Media" />
                </div>
